...
<?php
  $errMsg = "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
      if (strpos($errMsg, 'signup_tutor.php?error=empty') !== false){
  ...
  $Msg = "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
      if (strpos($Msg, 'signup_tutor.php?error=password') !== false){
  ...
  $Msg1 = "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
      if (strpos($Msg1, 'signup_tutor.php?error=username') !== false){
  ...
  ?>
    ...
    <div class="login-container d-flex align-items-center justify-content-center">
      <form class="signup-form text-center" action="signupcode_tutor.php" method="post">
