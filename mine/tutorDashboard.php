				...
				<div class="page-content">
					...
					<div class="state-overview">
							...
							<div class="form-group row">
								...
								<div class="col-md-5" style="color:#94f; font-size:1.4rem"><?=$results['degree'];?>	</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<label class="control-label col-md-3" style="color:#06f; font-size:1.3rem">Joining Date:</label>
								<div class="col-md-5" style="color:#94f; font-size:1.4rem"><?=$results['joinDate'];?>	</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<label class="control-label col-md-3" style="color:#06f; font-size:1.3rem">Bio:</label>
								<div class="col-md-5" style="color:#94f; font-size:1.4rem"><?=$results['bio'];?>	</div>
							</div>
							<div class="form-group row">
								<label class="control-label col-md-3" style="color:#06f; font-size:1.3rem">Session Records:</label>
								<div class="col-md-9" style="color:#000; font-size:1.2rem">
							<table class="table table-bordered table-condensed table-striped">
								<thead>
									<th></th><th>Year</th><th>Semester</th><th>Courses</th><th>Hours Taught</th><th></th>
								</thead>
								<tbody>
									<tr>
										<td></td>
							...
							<div class="home_btns m-top-40">
								<button class="submit-btn mt-5"><a href="tutor_update.php">Update Your Details</a></button>
							</div>
							<br>
