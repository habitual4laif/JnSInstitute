...
<?php
  $errMsg = "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
      if (strpos($errMsg, 'tutor_update.php?error=empty') !== false){
          echo "<div style='text-align:center; font-size:1rem; color:#f69'>You left empty field(s)</div>";
      }
  ?>
								<div class="card-body" id="bar-parent">
									<form action="updateform_tutor.php" method="post" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="input-append date" id="dp1">
													<input class="formDatePicker" placeholder="Registration Date"
														size="44" type="text" name="joinDate" readonly>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-control input-height" name="degree">
											...
											<div class="form-group row">
												...
												<form action="updateform.php" method="post" class="form-group" enctype="multipart/form-data">
													...
													<button type="submit" name="submit" class="btn btn-info" style="margin-left:1rem">Upload Image</button>
